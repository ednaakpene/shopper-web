  ...
  return (
    <footer class="text-black">
      <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 border-t border-white-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 dark:border-white-800">
          <div>
          ...
          <div>
            <p class="font-medium text-white-900 dark:text-white">
              Helpful Links
            </p>
        ...
        <p class="text-xs text-white-500 dark:text-white-400">
          &copy; 2024. Valmart . All rights reserved.
        </p>
      </div>
    </footer>
  );
